...
<body style=" margin:0;">
    <div style="display:flex; justify-content: space-between; align-items: center; width: 100%; position: fixed; background: #85C429; padding: 20px 0; top: 0;">
        ...
        ?>    
            ...
            <a href="Task_C_login.php" style="color: black; text-decoration: none; padding: 15px; margin-left:0; margin-right: 10px;">Logout</a>
        </span>
    </div>
    ...
    <div class = "dashboard">
        ...
        <nav>
            ...
            <a style="text-decoration: none;" href="Task_F_profile.php">View Profile</a>
            <a style="text-decoration: none;" href="Task_F_edit_profile.php">Edit Profile</a>
